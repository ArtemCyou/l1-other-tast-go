...
func main() {
	...
	//реализация быстрой сортировки go (Быстрая сортировка, сортировка Хоара основана на принципе разделяй и властвуй)
	quickSort(arrA, 0, len(arrA)-1)
	fmt.Printf("Отсортированный массив (quickSort): %v\n\n", arrA)

	//сортировка встроенными методами языка из пакета sort
	otherSort(arrA)
}
